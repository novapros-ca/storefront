        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-lg text-primary-foreground">NovaPros</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm text-primary-foreground/70">Tenue de livres</li>
              <li className="text-sm text-primary-foreground/70">Soutien RH administratif</li>
              <li className="text-sm text-primary-foreground/70">Soutien opérationnel</li>
              <li className="text-sm text-primary-foreground/70">Gestion immobilière</li>
            </ul>
          </div>
        </div>
