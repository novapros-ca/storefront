...
export function CareersSection() {
  return (
    <section className="py-16 lg:py-24 bg-secondary/30" id="carrieres">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <Card className="bg-card border-border">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-foreground mb-4">Profils recherchés</h3>
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-foreground mb-4">Qualités recherchées</h3>
                <ul className="space-y-3">
